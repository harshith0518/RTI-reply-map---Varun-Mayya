    ...
    <section className="how-section" id="how-it-works" aria-labelledby="how-title">
      ...
      <div className="build-boundary">
        ...
        <div>
          ...
          <p>Government filing, payment, live status, email or SMS alerts, document extraction and legal decisions.</p>
        </div>
      </div>
      <div className="roadmap-block" aria-labelledby="roadmap-title">
        ...
        <ol>
          ...
          <li><span>02</span><div><strong>Email and SMS alerts</strong><p>Remind citizens about replies, appeal actions and status changes after verified dates.</p></div></li>
